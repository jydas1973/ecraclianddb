#!/bin/sh
#
# $Header: dbaas/opc/exadata/ecra/db/make_resource.sh /main/1 2015/02/24 12:17:16 angfigue Exp $
#
# make_resource.sh
#
...
#
#    NAME
#      make_resource.sh - <one-line expansion of the name>
#
#    DESCRIPTION
...
#
#    MODIFIED   (MM/DD/YY)
#    angfigue    02/24/15 - script to generate the resource
#    angfigue    02/24/15 - Creation
...
cd $project;
$java -cp $wlst weblogic.WLST $sdir/weblogicdb.jy
cd $sdir;
